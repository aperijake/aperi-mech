 ...
 */
std::vector<FieldData> GetFieldData(bool uses_generalized_fields, bool use_strain_smoothing, bool uses_incremental_formulation, bool output_coefficients, bool add_debug_fields = false);
