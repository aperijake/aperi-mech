...
/**
 * @brief Class for the explicit time integrator.
 *
...
class ExplicitTimeIntegrator {
   public:
    ...
    struct ComputeAccelerationFunctor {
       ...
       private:
        // Fields
        mutable aperi::Field<double> m_mass_field;
        mutable aperi::Field<double> m_force_coefficients_field;
    ...
    struct ComputeFirstPartialUpdateFunctor {
       ...
       private:
        // Fields
        mutable aperi::Field<double> m_velocity_coefficients_n_field;
        mutable aperi::Field<double> m_acceleration_coefficients_n_field;
    ...
    struct UpdateDisplacementsFunctor {
        // Constructor
        UpdateDisplacementsFunctor(const aperi::Field<double> &displacement_coefficients_n_field, const aperi::Field<double> &velocity_coefficients_np1_field, const aperi::Field<double> &displacement_coefficients_np1_field, const Kokkos::View<double> &time_increment_device)
       ...
       private:
        // Fields
        mutable aperi::Field<double> m_displacement_coefficients_n_field;
        mutable aperi::Field<double> m_velocity_coefficients_np1_field;
   ...
   private:
    ...
    UpdateDisplacementsFunctor m_update_displacements_functor;                  // Update displacements functor
