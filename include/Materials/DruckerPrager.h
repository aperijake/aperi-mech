...
*/
  ...
  struct DruckerPragerGetStressFunctor : public StressFunctor {
    ...
    KOKKOS_FUNCTION
    DruckerPragerGetStressFunctor(double K, double G, double A1, double A2, double A2G) :
      m_bulk_modulus(K),
      m_shear_modulus(G),
      m_A1(A1),
      m_A2(A2),
    ...
    void GetStress(
      ...
      Eigen::Map<Eigen::Matrix<double, 3, 3>, 0, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>>& pk1_stress
    ) const override {
