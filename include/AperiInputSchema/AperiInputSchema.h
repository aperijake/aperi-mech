...
inline InputSchemaCreator GetXComponentSchemaCreator() {
    InputSchemaCreator schema_creator("X", "float", "the x component value");
    return schema_creator;
}

inline InputSchemaCreator GetYComponentSchemaCreator() {
    InputSchemaCreator schema_creator("Y", "float", "the y component value");
    return schema_creator;
}

inline InputSchemaCreator GetZComponentSchemaCreator() {
    InputSchemaCreator schema_creator("Z", "float", "the z component value");
    return schema_creator;
}

inline InputSchemaCreator GetComponentsSchemaCreator() {
...
inline InputSchemaCreator GetAbscissaValuesSchemaCreator() {
    InputSchemaCreator schema_creator("abscissa_values", "float_vector", "the abscissa values");
    return schema_creator;
}

inline InputSchemaCreator GetOrdinateValuesSchemaCreator() {
    InputSchemaCreator schema_creator("ordinate_values", "float_vector", "the ordinate values");
    return schema_creator;
}

inline InputSchemaCreator GetRampFunctionSchemaCreator() {
...
inline InputSchemaCreator GetSmoothStepFunctionSchemaCreator() {
...
inline InputSchemaCreator GetTimeFunctionSchemaCreator() {
...
inline InputSchemaCreator GetActiveTimeRangeSchemaCreator() {
...
inline InputSchemaCreator GetDirectTimeStepperSchemaCreator() {
...
inline InputSchemaCreator GetPowerMethodTimeStepperSchemaCreator() {
...
inline InputSchemaCreator GetTimeStepperSchemaCreator() {
...
inline InputSchemaCreator GetOutputCoefficientsSchemaCreator() {
    InputSchemaCreator schema_creator("output_coefficients", "bool", "indicates whether to output coefficients");
    return schema_creator;
}

inline InputSchemaCreator GetOutputSchemaCreator() {
...
inline InputSchemaCreator GetGravityLoadSchemaCreator() {
...
inline InputSchemaCreator GetLoadsSchemaCreator() {
...
inline InputSchemaCreator GetAllExteriorSurfacesSchemaCreator() {
    InputSchemaCreator schema_creator("all_exterior_surfaces", "map", "the all exterior surfaces condition");
    return schema_creator;
}

inline InputSchemaCreator GetPenaltyScaleFactorSchemaCreator() {
    InputSchemaCreator schema_creator("penalty_scale_factor", "float", "the penalty scale factor");
    return schema_creator;
}

inline InputSchemaCreator GetPinballSchemaCreator() {
    InputSchemaCreator schema_creator("pinball", "map", "the pinball contact conditions");
    schema_creator.AddOneOf({GetSetsSchemaCreator().GetInputSchema(),
                             GetAllExteriorSurfacesSchemaCreator().GetInputSchema()});
    schema_creator.AddOptional(GetPenaltyScaleFactorSchemaCreator().GetInputSchema());
    return schema_creator;
}

inline InputSchemaCreator GetContactSchemaCreator() {
    InputSchemaCreator schema_creator("contact", "sequence", "the contact configuration");
    schema_creator.AddOneOf({GetPinballSchemaCreator().GetInputSchema()});
    return schema_creator;
}

inline InputSchemaCreator GetInitialVelocitySchemaCreator() {
...
inline InputSchemaCreator GetInitialConditionsSchemaCreator() {
...
inline InputSchemaCreator GetSpecifiedVelocitySchemaCreator() {
...
inline InputSchemaCreator GetSpecifiedDisplacementSchemaCreator() {
...
inline InputSchemaCreator GetBoundaryConditionsSchemaCreator() {
...
inline InputSchemaCreator GetElasticSchemaCreator() {
...
inline InputSchemaCreator GetNeoHookeanSchemaCreator() {
...
inline InputSchemaCreator GetNeoHookeanWithDamageSchemaCreator() {
...
inline InputSchemaCreator GetPlasticSchemaCreator() {
...
inline InputSchemaCreator GetDruckerPragerSchemaCreator() {
...
inline InputSchemaCreator GetPowerLawCreepSchemaCreator() {
...
inline InputSchemaCreator GetMaterialSchemaCreator() {
...
inline InputSchemaCreator GetIntegrationOrderSchemaCreator() {
    InputSchemaCreator schema_creator("integration_order", "int", "the integration order");
    return schema_creator;
}

inline InputSchemaCreator GetGaussQuadratureSchemaCreator() {
...
inline InputSchemaCreator GetIntegrationSchemeSchemaCreator() {
...
inline InputSchemaCreator GetFiniteElementSchemaCreator() {
    InputSchemaCreator schema_creator("finite_element", "map", "finite element approximation");
    return schema_creator;
}

inline InputSchemaCreator GetKernelRadiusScaleFactorSchemaCreator() {
    InputSchemaCreator schema_creator("kernel_radius_scale_factor", "float", "the kernel radius scale factor");
    return schema_creator;
}

inline InputSchemaCreator GetReproducingKernelSchemaCreator() {
...
inline InputSchemaCreator GetApproximationSpaceSchemaCreator() {
...
inline InputSchemaCreator GetFormulationSchemaCreator() {
...
inline InputSchemaCreator GetPartSchemaCreator() {
...
inline InputSchemaCreator GetPartsSchemaCreator() {
...
inline InputSchemaCreator GetExplicitDynamicsProcedureSchemaCreator() {
    ...
    schema_creator.AddOptional(GetContactSchemaCreator().GetInputSchema());
    schema_creator.AddOptional(GetLagrangianSchemaCreator().GetInputSchema());
    return schema_creator;
}

inline InputSchemaCreator GetProceduresSchemaCreator() {
