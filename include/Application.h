 ...
 * getting the field data and initial conditions, creating the field manager and the IO mesh object,
 * reading the mesh, and creating the field results file.
 */
class Application {
   public:
    /**
     ...
     * creates the field manager and the IO mesh object, reads the mesh, and creates
     * the field results file.
     *
