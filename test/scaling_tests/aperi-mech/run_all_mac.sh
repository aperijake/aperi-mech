...
./batch_run.sh taylor_bar_1e4_hexes/rkpm
./batch_run.sh taylor_bar_1e4_hexes/rkpm_nodal

./batch_run.sh taylor_bar_8e4_tets/fem
./batch_run.sh taylor_bar_8e4_tets/rkpm
./batch_run.sh taylor_bar_8e4_tets/rkpm_nodal
