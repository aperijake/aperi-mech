...
# plot the results
plt.loglog(df1["Nodes"], df1["Compadre Runtime (s)"], label="Compadre CPU", marker="o", color="red")
plt.loglog(df1["Nodes"], df1["Reproducing Kernel Runtime (s)"], label="Reproducing Kernel CPU", marker="o", color="blue")
plt.loglog(df2["Nodes"], df2["Compadre Runtime (s)"], label="Compadre GPU", marker="o", color="red", linestyle="--")
plt.loglog(df2["Nodes"], df2["Reproducing Kernel Runtime (s)"], label="Reproducing Kernel GPU", marker="o", color="blue", linestyle="--")
