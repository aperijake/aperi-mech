...
class NodeProcessingTestFixture : public ::testing::Test {
   protected:
    ...
    void AddMeshDatabase(size_t num_elements_x, size_t num_elements_y, size_t num_elements_z) {
        ...
        // Create the fields
        aperi::DoubleField *p_velocity_field = &p_meta_data->declare_field<double>(stk::topology::NODE_RANK, "velocity", 2);
        ...
        aperi::DoubleField *p_acceleration_field = &p_meta_data->declare_field<double>(stk::topology::NODE_RANK, "acceleration", 2);
    ...
    aperi::DoubleField *m_velocity_field_np1;
