...
TEST_F(InitialConditionUtilTest, AddInitialConditionsValidInput) {
    ...
    auto magnitude = m_yaml_data["procedures"][0]["explicit_dynamics_procedure"]["initial_conditions"][0]["velocity"]["vector"]["magnitude"].as<double>();
    auto expected_values = m_yaml_data["procedures"][0]["explicit_dynamics_procedure"]["initial_conditions"][0]["velocity"]["vector"]["direction"].as<std::array<double, 3>>();
...
TEST_F(InitialConditionUtilTest, AddInitialConditionsTwoInitialConditions) {
    ...
    // Get the initial condition values
    auto magnitude_1 = m_yaml_data["procedures"][0]["explicit_dynamics_procedure"]["initial_conditions"][0]["velocity"]["vector"]["magnitude"].as<double>();
    auto expected_values_1 = m_yaml_data["procedures"][0]["explicit_dynamics_procedure"]["initial_conditions"][0]["velocity"]["vector"]["direction"].as<std::array<double, 3>>();
    ...
    auto expected_values_2 = m_yaml_data["procedures"][0]["explicit_dynamics_procedure"]["initial_conditions"][1]["velocity"]["vector"]["direction"].as<std::array<double, 3>>();
