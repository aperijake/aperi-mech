...
TEST_F(SolverTest, Explicit) {
    ...
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {}, "displacement", expected_displacement, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {}, "velocity", expected_velocity, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {}, "acceleration", expected_acceleration, aperi::FieldQueryState::N);
}
...
void TestGravity(const YAML::Node& yaml_data, const std::shared_ptr<aperi::Solver>& solver, int num_procs, int num_blocks) {
    ...
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*solver->GetMeshData(), {}, "displacement", expected_displacement, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*solver->GetMeshData(), {}, "velocity", expected_velocity, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*solver->GetMeshData(), {}, "acceleration", expected_acceleration, aperi::FieldQueryState::N);
    ...
    CheckEntityFieldSum<aperi::FieldDataTopologyRank::NODE>(*solver->GetMeshData(), {}, "mass", expected_mass, aperi::FieldQueryState::None);
}
...
TEST_F(SolverTest, ExplicitBoundaryConditionsTwoSets) {
    ...
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {"surface_1"}, "displacement", expected_displacement_1, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {"surface_1"}, "velocity", expected_velocity_1, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {"surface_1"}, "acceleration", expected_acceleration_1, aperi::FieldQueryState::N);
    ...
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {"surface_2"}, "displacement", expected_displacement_2, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {"surface_2"}, "velocity", expected_velocity_2, aperi::FieldQueryState::N);
    CheckEntityFieldValues<aperi::FieldDataTopologyRank::NODE>(*m_solver->GetMeshData(), {"surface_2"}, "acceleration", expected_acceleration_2, aperi::FieldQueryState::N);
}
