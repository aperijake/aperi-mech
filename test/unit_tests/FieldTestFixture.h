...
class FieldTestFixture : public ::testing::Test {
   protected:
    ...
    void AddMeshDatabase(size_t num_elements_x, size_t num_elements_y, size_t num_elements_z) {
        ...
        aperi::RealField *p_nodal_field = &p_meta_data->declare_field<double>(stk::topology::NODE_RANK, "nodal_field", 2);
        ...
        aperi::RealField *p_nodal_field_2 = &p_meta_data->declare_field<double>(stk::topology::NODE_RANK, "nodal_field_2", 1);
        ...
        aperi::RealField *p_element_field = &p_meta_data->declare_field<double>(stk::topology::ELEMENT_RANK, "element_field", 1);
